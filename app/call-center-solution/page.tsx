  ...
  return (
    <>
      <section className="relative flex items-center justify-end h-auto min-h-[80vh] w-full overflow-hidden">
        <Image
          src="/images/solutions/call-center/Call-center-Solution.webp"
      ...
      <section className="py-8 px-6 sm:px-10 md:px-16 flex flex-col md:flex-row items-center gap-10">
        <div className="w-full md:w-[40%] flex justify-center">
          <Image
            src="/images/Call-Center-01.webp"
              ...
              {card.features?.length > 0 && (
                <ul className="flex flex-col gap-2">
                  {card.features.map((feature, index) => (
                    <li
                      key={index}
                      className="font-medium list-disc ml-8 marker:text-[#1E4EC4] text-black group-hover:text-white"
                    >
                      {feature}
                    </li>
                  ))}
      ...
      <section className="bg-gray-100 py-16 px-6 md:px-14 text-center flex flex-col items-center">
        <div className="max-w-5xl flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="md:basis-[45%] flex justify-center">
            ...
            >
              <Image
                src="/images/Call-Center-Solution-Group.webp"
                alt="Call Center Solution"
                width={500}
                height={400}
                className="object-contain"
